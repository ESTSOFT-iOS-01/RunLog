...
final class CardView: UIView {
    ...
    private func setupUI() {
        ...
        finishButton.snp.makeConstraints {
            $0.leading.trailing.equalToSuperview().inset(DynamicSize.getWidth(36))
            $0.bottom.equalToSuperview().inset(DynamicSize.getHeight(31))
        }
        timeLabel.snp.makeConstraints {
            $0.top.equalToSuperview().inset(DynamicSize.getHeight(36))
            $0.leading.trailing.equalToSuperview().inset(DynamicSize.getWidth(36))
            $0.height.equalTo(DynamicSize.getHeight(79))
        }
        distanceLabel.snp.makeConstraints {
            $0.leading.equalTo(timeLabel)
            $0.trailing.equalTo(timeLabel.snp.centerX)
            $0.top.equalTo(timeLabel.snp.bottom).offset(DynamicSize.getHeight(12))
            $0.bottom.equalTo(finishButton.snp.top).offset(-DynamicSize.getHeight(20))
        }
    ...
    private func configure() {
        ...
        distanceLabel.setConfigure(text: "0.00km")
